...
double predict_blood_pressure(double feature_vector[], double max_bp, double min_bp)
{
  ...
  double layer1_weights_reg[INPUT_DIMENSION * NUM_NEURONS1] = {
      -0.3503994,
      -0.11415278,
      0.23711745,
      -0.019606477,
  ...
  double layer2_weights_reg[NUM_NEURONS1 * NUM_NEURONS2] = {
      0.34514788,
      -0.18000464,
      -0.11764939,
      -0.029070795,
  ...
  double layer3_weights_reg[NUM_NEURONS2 * NUM_NEURONS3] = {
      0.33762398,
      -0.3324992,
      0.07271413,
      0.18190984,
